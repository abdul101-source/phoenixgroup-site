    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-5 justify-center">
          <a href="https://app.varixintelligence.com/signup" className="btn-primary text-lg">
      ...
      <section className="py-20 text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-3xl p-10 shadow-xl">
            ...
            <a href="https://app.varixintelligence.com/signup" className="btn-primary block text-xl py-4">
              Start free trial – no card required
            </a>
